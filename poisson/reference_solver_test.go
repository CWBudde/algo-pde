...
func TestReferenceSolve2D_Random(t *testing.T) {
	cases := []struct {
		...
		{"QuarterWaveDNxND", 12, 14, 1.0 / 12, 0.8 / 14, [2]poisson.BCType{poisson.DirichletNeumann, poisson.NeumannDirichlet}, 0},
		{"QuarterWaveWithDirichlet", 8, 12, 1.0 / 9, 1.0 / 12, [2]poisson.BCType{poisson.NeumannDirichlet, poisson.Dirichlet}, 0},
		{"HelmholtzQuarterWave", 12, 8, 1.0 / 12, 1.0 / 8, [2]poisson.BCType{poisson.DirichletNeumann, poisson.NeumannDirichlet}, 2.0},
	}
