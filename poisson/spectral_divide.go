...
// divByReal64 is the float32 analogue used by the real-FFT (single-precision)
// spectral divides. The float32 paths carry a documented ~1e-6 accuracy contract,
// which a direct single-precision divide sits well inside.
func divByReal64(z complex64, d float32) complex64 {
	return complex(real(z)/d, imag(z)/d)
}
